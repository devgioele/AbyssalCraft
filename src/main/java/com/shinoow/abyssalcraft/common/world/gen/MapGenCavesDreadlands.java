							...
							for (int j3 = l2; j3 < i1; ++j3)
							{
								...
								for (int i2 = l; i2 > k2; --i2)
								{
									...
									if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D)
									{
										...
										if (iblockstate1 == ACBlocks.getInstance().dreadstone.getBlock().getDefaultState() || iblockstate1 == ACBlocks.getInstance().abyssalnite_stone.getBlock().getDefaultState() || iblockstate1.getBlock() == ACBlocks.getInstance().dreadlands_dirt.getBlock() || iblockstate1.getBlock() == ACBlocks.getInstance().dreadlands_grass.getBlock())
