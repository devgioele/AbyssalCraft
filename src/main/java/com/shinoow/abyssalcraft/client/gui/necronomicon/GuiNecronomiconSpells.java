...
public class GuiNecronomiconSpells extends GuiNecronomicon {
	...
	public void initGui()
	{
		...
		buttonList.add(buttonCat1 = new ButtonCategory(3, i + 14, b0 + 24, this, NecronomiconText.LABEL_CREATE_SPELLS, false, ACItems.getInstance().necronomicon));
		buttonList.add(buttonCat2 = new ButtonCategory(4, i + 14, b0 + 41, this, NecronomiconText.LABEL_OPEN_COMPENDIUM, false, hasSpells() ? ACItems.getInstance().necronomicon : ACItems.getInstance().oblivion_catalyst));
		buttonList.add(buttonCat3 = new ButtonCategory(5, i + 14, b0 + 58, this, NecronomiconText.LABEL_INFO, false, ACItems.getInstance().necronomicon));
