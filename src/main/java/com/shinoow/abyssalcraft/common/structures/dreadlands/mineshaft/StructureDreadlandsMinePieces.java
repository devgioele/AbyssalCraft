...
public class StructureDreadlandsMinePieces
{
	...
	public static class Corridor extends StructureComponent
	{
		...
		public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
		{
			...
			else
			{
				...
				{
					k = 2 + j * 5;
					fillWithBlocks(par1World, par3StructureBoundingBox, 0, 0, k, 0, 1, k, ACBlocks.getInstance().dreadlands_wood_fence.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
					fillWithBlocks(par1World, par3StructureBoundingBox, 2, 0, k, 2, 1, k, ACBlocks.getInstance().dreadlands_wood_fence.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);

					if (par2Random.nextInt(4) == 0)
					{
						fillWithBlocks(par1World, par3StructureBoundingBox, 0, 2, k, 0, 2, k, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
						fillWithBlocks(par1World, par3StructureBoundingBox, 2, 2, k, 2, 2, k, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
					} else
						fillWithBlocks(par1World, par3StructureBoundingBox, 0, 2, k, 2, 2, k, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
				...
				for (j = 0; j <= 2; ++j)
					for (k = 0; k <= i; ++k)
					{
						...
						{
							byte b1 = -1;
							setBlockState(par1World, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), j, b1, k, par3StructureBoundingBox);
						}
					}
	...
	public static class Cross extends StructureComponent
	{
		...
		public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
		{
			...
			else
			{
				...
				fillWithBlocks(par1World, par3StructureBoundingBox, boundingBox.minX + 1, boundingBox.minY, boundingBox.minZ + 1, boundingBox.minX + 1, boundingBox.maxY, boundingBox.minZ + 1, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
				fillWithBlocks(par1World, par3StructureBoundingBox, boundingBox.minX + 1, boundingBox.minY, boundingBox.maxZ - 1, boundingBox.minX + 1, boundingBox.maxY, boundingBox.maxZ - 1, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
				fillWithBlocks(par1World, par3StructureBoundingBox, boundingBox.maxX - 1, boundingBox.minY, boundingBox.minZ + 1, boundingBox.maxX - 1, boundingBox.maxY, boundingBox.minZ + 1, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
				fillWithBlocks(par1World, par3StructureBoundingBox, boundingBox.maxX - 1, boundingBox.minY, boundingBox.maxZ - 1, boundingBox.maxX - 1, boundingBox.maxY, boundingBox.maxZ - 1, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), false);
				...
				for (int i = boundingBox.minX; i <= boundingBox.maxX; ++i)
					for (int j = boundingBox.minZ; j <= boundingBox.maxZ; ++j)
						if (getBlockStateFromPos(par1World, i, boundingBox.minY - 1, j, par3StructureBoundingBox).getMaterial() == Material.AIR)
							setBlockState(par1World, ACBlocks.getInstance().dreadlands_planks.getBlock().getDefaultState(), i, boundingBox.minY - 1, j, par3StructureBoundingBox);
	...
	public static class Room extends StructureComponent
	{
		...
		public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
		{
			...
			{
				fillWithBlocks(par1World, par3StructureBoundingBox, boundingBox.minX, boundingBox.minY, boundingBox.minZ, boundingBox.maxX, boundingBox.minY, boundingBox.maxZ, ACBlocks.getInstance().dreadlands_grass.getBlock().getDefaultState(), Blocks.AIR.getDefaultState(), true);
