...
public class BlockHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ACBlocks.darkstone_brick =new ACBlock( new BlockACBrick(1.65F, 12.0F, MapColor.BLACK).setTranslationKey("darkstone_brick"));
		ACBlocks.chiseled_darkstone_brick =new ACBlock( new BlockACBrick(1.65F, 12.0F, MapColor.BLACK).remap("darkstone_brick", EnumBrickType.CHISELED).setTranslationKey("chiseled_darkstone_brick"));
		ACBlocks.cracked_darkstone_brick =new ACBlock( new BlockACBrick(1.65F, 12.0F, MapColor.BLACK).remap("darkstone_brick", EnumBrickType.CRACKED).setTranslationKey("cracked_darkstone_brick"));
		...
		ACBlocks.abyssal_stone_brick =new ACBlock( new BlockACBrick(2, 1.8F, 12.0F, MapColor.GREEN).setTranslationKey("abybrick"), abyssal_wasteland);
		ACBlocks.chiseled_abyssal_stone_brick =new ACBlock( new BlockACBrick(2, 1.8F, 12.0F, MapColor.GREEN).remap("abybrick", EnumBrickType.CHISELED).setTranslationKey("chiseled_abyssal_stone_brick"), abyssal_wasteland);
		ACBlocks.cracked_abyssal_stone_brick =new ACBlock( new BlockACBrick(2, 1.8F, 12.0F, MapColor.GREEN).remap("abybrick", EnumBrickType.CRACKED).setTranslationKey("cracked_abyssal_stone_brick"), abyssal_wasteland);
		...
		ACBlocks.dreadstone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.RED).setTranslationKey("dreadbrick"), dreadlands);
		ACBlocks.chiseled_dreadstone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.RED).remap("dreadbrick", EnumBrickType.CHISELED).setTranslationKey("chiseled_dreadstone_brick"), dreadlands);
		ACBlocks.cracked_dreadstone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.RED).remap("dreadbrick", EnumBrickType.CRACKED).setTranslationKey("cracked_dreadstone_brick"), dreadlands);
		ACBlocks.abyssalnite_stone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.PURPLE).setTranslationKey("abydreadbrick"), dreadlands);
		ACBlocks.chiseled_abyssalnite_stone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.PURPLE).remap("abydreadstone", EnumBrickType.CHISELED).setTranslationKey("chiseled_abyssalnite_stone_brick"), dreadlands);
		ACBlocks.cracked_abyssalnite_stone_brick =new ACBlock( new BlockACBrick(4, 2.5F, 20.0F, MapColor.PURPLE).remap("abydreadbrick", EnumBrickType.CRACKED).setTranslationKey("cracked_abyssalnite_stone_brick"), dreadlands);
		...
		ACBlocks.coralium_stone_brick =new ACBlock( new BlockACBrick(1.5F, 10.0F, MapColor.CYAN).setTranslationKey("cstonebrick"),abyssal_wasteland);
		ACBlocks.chiseled_coralium_stone_brick =new ACBlock( new BlockACBrick(1.5F, 10.0F, MapColor.CYAN).remap("cstonebrick", EnumBrickType.CHISELED).setTranslationKey("chiseled_coralium_stone_brick"),abyssal_wasteland);
		ACBlocks.cracked_coralium_stone_brick =new ACBlock( new BlockACBrick(1.5F, 10.0F, MapColor.CYAN).remap("cstonebrick", EnumBrickType.CRACKED).setTranslationKey("cracked_coralium_stone_brick"),abyssal_wasteland);
		...
		ACBlocks.ethaxium_brick =new ACBlock( new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).setTranslationKey("ethaxiumbrick"),omothol);
		ACBlocks.chiseled_ethaxium_brick =new ACBlock( new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).remap("ethaxiumbrick", EnumBrickType.CHISELED).setTranslationKey("chiseled_ethaxium_brick"),omothol);
		ACBlocks.cracked_ethaxium_brick =new ACBlock( new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).remap("ethaxiumbrick", EnumBrickType.CRACKED).setTranslationKey("cracked_ethaxium_brick"),omothol);
		...
		ACBlocks.dark_ethaxium_brick =new ACBlock( new BlockACBrick(8, 150.0F, Float.MAX_VALUE).setTranslationKey("darkethaxiumbrick"),omothol);
		ACBlocks.chiseled_dark_ethaxium_brick =new ACBlock( new BlockACBrick(8, 150.0F, Float.MAX_VALUE).remap("darkethaxiumbrick", EnumBrickType.CHISELED).setTranslationKey("chiseled_dark_ethaxium_brick"),omothol);
		ACBlocks.cracked_dark_ethaxium_brick =new ACBlock( new BlockACBrick(8, 150.0F, Float.MAX_VALUE).remap("darkethaxiumbrick", EnumBrickType.CRACKED).setTranslationKey("cracked_dark_ethaxium_brick"),omothol);
		...
		ACBlocks.ritual_altar_stone =new ACBlock( new BlockRitualAltar(
				Blocks.COBBLESTONE::getDefaultState, 0, EnumRitualMatType.COBBLESTONE).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_darkstone =new ACBlock( new BlockRitualAltar(() -> ACBlocks.darkstone_cobblestone.getBlock().getDefaultState(), 0, EnumRitualMatType.DARKSTONE_COBBLESTONE).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_abyssal_stone =new ACBlock( new BlockRitualAltar(() -> ACBlocks.abyssal_cobblestone.getBlock().getDefaultState(), 1, EnumRitualMatType.ABYSSAL_STONE_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_coralium_stone =new ACBlock( new BlockRitualAltar(() -> ACBlocks.coralium_cobblestone.getBlock().getDefaultState(), 1, EnumRitualMatType.CORALIUM_STONE_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_dreadstone =new ACBlock( new BlockRitualAltar(() -> ACBlocks.dreadstone_cobblestone.getBlock().getDefaultState(), 2, EnumRitualMatType.DREADSTONE_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_abyssalnite_stone =new ACBlock( new BlockRitualAltar(() -> ACBlocks.abyssalnite_cobblestone.getBlock().getDefaultState(), 2, EnumRitualMatType.ABYSSALNITE_STONE_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_ethaxium =new ACBlock( new BlockRitualAltar(() -> ACBlocks.ethaxium_brick.getBlock().getDefaultState(), 3, EnumRitualMatType.ETHAXIUM_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_altar_dark_ethaxium =new ACBlock( new BlockRitualAltar(() -> ACBlocks.dark_ethaxium_brick.getBlock().getDefaultState(), 3, EnumRitualMatType.DARK_ETHAXIUM_BRICK).setTranslationKey("ritualaltar"));
		ACBlocks.ritual_pedestal_stone =new ACBlock( new BlockRitualPedestal(
				Blocks.COBBLESTONE::getDefaultState, 0, EnumRitualMatType.COBBLESTONE).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_darkstone =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.darkstone_cobblestone.getBlock().getDefaultState(), 0, EnumRitualMatType.DARKSTONE_COBBLESTONE).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_abyssal_stone =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.abyssal_cobblestone.getBlock().getDefaultState(), 1, EnumRitualMatType.ABYSSAL_STONE_BRICK).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_coralium_stone =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.coralium_cobblestone.getBlock().getDefaultState(), 1, EnumRitualMatType.CORALIUM_STONE_BRICK).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_dreadstone =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.dreadstone_cobblestone.getBlock().getDefaultState(), 2, EnumRitualMatType.DREADSTONE_BRICK).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_abyssalnite_stone =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.abyssalnite_cobblestone.getBlock().getDefaultState(), 2, EnumRitualMatType.ABYSSALNITE_STONE_BRICK).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_ethaxium =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.ethaxium_brick.getBlock().getDefaultState(), 3, EnumRitualMatType.ETHAXIUM_BRICK).setTranslationKey("ritualpedestal"));
		ACBlocks.ritual_pedestal_dark_ethaxium =new ACBlock( new BlockRitualPedestal(() -> ACBlocks.dark_ethaxium_brick.getBlock().getDefaultState(), 3, EnumRitualMatType.DARK_ETHAXIUM_BRICK).setTranslationKey("ritualpedestal"));
		...
		ACBlocks.overworld_energy_pedestal =new ACBlock( new BlockTieredEnergyPedestal(EnumDimType.OVERWORLD).setTranslationKey("overworld_energy_pedestal"), new ItemPEContainerBlock(ACBlocks.overworld_energy_pedestal.getBlock()));
		ACBlocks.abyssal_wasteland_energy_pedestal =new ACBlock( new BlockTieredEnergyPedestal(EnumDimType.ABYSSAL_WASTELAND).setTranslationKey("abyssal_wasteland_energy_pedestal"), new ItemPEContainerBlock(ACBlocks.abyssal_wasteland_energy_pedestal.getBlock()), abyssal_wasteland);
		ACBlocks.dreadlands_energy_pedestal =new ACBlock( new BlockTieredEnergyPedestal(EnumDimType.DREADLANDS).setTranslationKey("dreadlands_energy_pedestal"), new ItemPEContainerBlock(ACBlocks.dreadlands_energy_pedestal.getBlock()),dreadlands);
		ACBlocks.omothol_energy_pedestal =new ACBlock( new BlockTieredEnergyPedestal(EnumDimType.OMOTHOL).setTranslationKey("omothol_energy_pedestal"), new ItemPEContainerBlock(ACBlocks.omothol_energy_pedestal.getBlock()), omothol);
		ACBlocks.overworld_sacrificial_altar =new ACBlock( new BlockTieredSacrificialAltar(EnumDimType.OVERWORLD).setTranslationKey("overworld_sacrificial_altar"), new ItemPEContainerBlock(ACBlocks.overworld_sacrificial_altar.getBlock()));
		ACBlocks.abyssal_wasteland_sacrificial_altar =new ACBlock( new BlockTieredSacrificialAltar(EnumDimType.ABYSSAL_WASTELAND).setTranslationKey("abyssal_wasteland_sacrificial_altar"), new ItemPEContainerBlock(ACBlocks.abyssal_wasteland_sacrificial_altar.getBlock()), abyssal_wasteland);
		ACBlocks.dreadlands_sacrificial_altar =new ACBlock( new BlockTieredSacrificialAltar(EnumDimType.DREADLANDS).setTranslationKey("dreadlands_sacrificial_altar"), new ItemPEContainerBlock(ACBlocks.dreadlands_sacrificial_altar.getBlock()),dreadlands);
		ACBlocks.omothol_sacrificial_altar =new ACBlock( new BlockTieredSacrificialAltar(EnumDimType.OMOTHOL).setTranslationKey("omothol_sacrificial_altar"), new ItemPEContainerBlock(ACBlocks.omothol_sacrificial_altar.getBlock()), omothol);
		...
		ACBlocks.iron_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.IRON), new ItemCrystalClusterBlock(ACBlocks.iron_crystal_cluster.getBlock()));
		ACBlocks.gold_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.GOLD), new ItemCrystalClusterBlock(ACBlocks.gold_crystal_cluster.getBlock()));
		ACBlocks.sulfur_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.SULFUR), new ItemCrystalClusterBlock(ACBlocks.sulfur_crystal_cluster.getBlock()));
		ACBlocks.carbon_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.CARBON), new ItemCrystalClusterBlock(ACBlocks.carbon_crystal_cluster.getBlock()));
		ACBlocks.oxygen_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.OXYGEN), new ItemCrystalClusterBlock(ACBlocks.oxygen_crystal_cluster.getBlock()));
		ACBlocks.hydrogen_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.HYDROGEN), new ItemCrystalClusterBlock(ACBlocks.hydrogen_crystal_cluster.getBlock()));
		ACBlocks.nitrogen_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.NITROGEN), new ItemCrystalClusterBlock(ACBlocks.nitrogen_crystal_cluster.getBlock()));
		ACBlocks.phosphorus_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.PHOSPHORUS), new ItemCrystalClusterBlock(ACBlocks.phosphorus_crystal_cluster.getBlock()));
		ACBlocks.potassium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.POTASSIUM), new ItemCrystalClusterBlock(ACBlocks.potassium_crystal_cluster.getBlock()));
		ACBlocks.nitrate_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.NITRATE), new ItemCrystalClusterBlock(ACBlocks.nitrate_crystal_cluster.getBlock()));
		ACBlocks.methane_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.METHANE), new ItemCrystalClusterBlock(ACBlocks.methane_crystal_cluster.getBlock()));
		ACBlocks.redstone_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.REDSTONE), new ItemCrystalClusterBlock(ACBlocks.redstone_crystal_cluster.getBlock()));
		ACBlocks.abyssalnite_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.ABYSSALNITE), new ItemCrystalClusterBlock(ACBlocks.abyssalnite_crystal_cluster.getBlock()));
		ACBlocks.coralium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.CORALIUM), new ItemCrystalClusterBlock(ACBlocks.coralium_crystal_cluster.getBlock()));
		ACBlocks.dreadium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.DREADIUM), new ItemCrystalClusterBlock(ACBlocks.dreadium_crystal_cluster.getBlock()));
		ACBlocks.blaze_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType.BLAZE), new ItemCrystalClusterBlock(ACBlocks.blaze_crystal_cluster.getBlock()));
		ACBlocks.tin_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.TIN), new ItemCrystalClusterBlock(ACBlocks.tin_crystal_cluster.getBlock()));
		ACBlocks.copper_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.COPPER), new ItemCrystalClusterBlock(ACBlocks.copper_crystal_cluster.getBlock()));
		ACBlocks.silicon_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.SILICON), new ItemCrystalClusterBlock(ACBlocks.silicon_crystal_cluster.getBlock()));
		ACBlocks.magnesium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.MAGNESIUM), new ItemCrystalClusterBlock(ACBlocks.magnesium_crystal_cluster.getBlock()));
		ACBlocks.aluminium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.ALUMINIUM), new ItemCrystalClusterBlock(ACBlocks.aluminium_crystal_cluster.getBlock()));
		ACBlocks.silica_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.SILICA), new ItemCrystalClusterBlock(ACBlocks.silica_crystal_cluster.getBlock()));
		ACBlocks.alumina_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.ALUMINA), new ItemCrystalClusterBlock(ACBlocks.alumina_crystal_cluster.getBlock()));
		ACBlocks.magnesia_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.MAGNESIA), new ItemCrystalClusterBlock(ACBlocks.magnesia_crystal_cluster.getBlock()));
		ACBlocks.zinc_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.ZINC), new ItemCrystalClusterBlock(ACBlocks.zinc_crystal_cluster.getBlock()));
		ACBlocks.calcium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.CALCIUM), new ItemCrystalClusterBlock(ACBlocks.calcium_crystal_cluster.getBlock()));
		ACBlocks.beryllium_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.BERYLLIUM), new ItemCrystalClusterBlock(ACBlocks.beryllium_crystal_cluster.getBlock()));
		ACBlocks.beryl_crystal_cluster =new ACBlock( new BlockCrystalCluster().remap(EnumCrystalType2.BERYL), new ItemCrystalClusterBlock(ACBlocks.beryl_crystal_cluster.getBlock()));
		...
		ACBlocks.overworld_energy_collector =new ACBlock( new BlockTieredEnergyCollector(EnumDimType.OVERWORLD).setTranslationKey("overworld_energy_collector"), new ItemPEContainerBlock(ACBlocks.overworld_energy_collector.getBlock()));
		ACBlocks.abyssal_wasteland_energy_collector =new ACBlock( new BlockTieredEnergyCollector(EnumDimType.ABYSSAL_WASTELAND).setTranslationKey("abyssal_wasteland_energy_collector"), new ItemPEContainerBlock(ACBlocks.abyssal_wasteland_energy_collector.getBlock()),abyssal_wasteland);
		ACBlocks.dreadlands_energy_collector =new ACBlock( new BlockTieredEnergyCollector(EnumDimType.DREADLANDS).setTranslationKey("dreadlands_energy_collector"), new ItemPEContainerBlock(ACBlocks.dreadlands_energy_collector.getBlock()),dreadlands);
		ACBlocks.omothol_energy_collector =new ACBlock( new BlockTieredEnergyCollector(EnumDimType.OMOTHOL).setTranslationKey("omothol_energy_collector"), new ItemPEContainerBlock(ACBlocks.omothol_energy_collector.getBlock()),omothol);
		ACBlocks.overworld_energy_relay =new ACBlock( new BlockTieredEnergyRelay(EnumDimType.OVERWORLD).setTranslationKey("overworld_energy_relay"), new ItemPEContainerBlock(ACBlocks.overworld_energy_relay.getBlock()));
		ACBlocks.abyssal_wasteland_energy_relay =new ACBlock( new BlockTieredEnergyRelay(EnumDimType.ABYSSAL_WASTELAND).setTranslationKey("abyssal_wasteland_energy_relay"), new ItemPEContainerBlock(ACBlocks.abyssal_wasteland_energy_relay.getBlock()),abyssal_wasteland);
		ACBlocks.dreadlands_energy_relay =new ACBlock( new BlockTieredEnergyRelay(EnumDimType.DREADLANDS).setTranslationKey("dreadlands_energy_relay"), new ItemPEContainerBlock(ACBlocks.dreadlands_energy_relay.getBlock()),dreadlands);
		ACBlocks.omothol_energy_relay =new ACBlock( new BlockTieredEnergyRelay(EnumDimType.OMOTHOL).setTranslationKey("omothol_energy_relay"), new ItemPEContainerBlock(ACBlocks.omothol_energy_relay.getBlock()),omothol);
		ACBlocks.overworld_energy_container =new ACBlock( new BlockTieredEnergyContainer(EnumDimType.OVERWORLD).setTranslationKey("overworld_energy_container"), new ItemPEContainerBlock(ACBlocks.overworld_energy_container.getBlock()));
		ACBlocks.abyssal_wasteland_energy_container =new ACBlock( new BlockTieredEnergyContainer(EnumDimType.ABYSSAL_WASTELAND).setTranslationKey("abyssal_wasteland_energy_container"), new ItemPEContainerBlock(ACBlocks.abyssal_wasteland_energy_container.getBlock()),abyssal_wasteland);
		ACBlocks.dreadlands_energy_container =new ACBlock( new BlockTieredEnergyContainer(EnumDimType.DREADLANDS).setTranslationKey("dreadlands_energy_container"), new ItemPEContainerBlock(ACBlocks.dreadlands_energy_container.getBlock()),dreadlands);
		ACBlocks.omothol_energy_container =new ACBlock( new BlockTieredEnergyContainer(EnumDimType.OMOTHOL).setTranslationKey("omothol_energy_container"), new ItemPEContainerBlock(ACBlocks.omothol_energy_container.getBlock()),omothol);
