...
public class BlockHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ACBlocks.darklands_oak_sapling =new ACBlock( new BlockACSapling(new WorldGenDLT(true)).setHardness(0.0F).setResistance(0.0F).setTranslationKey("dltsapling")).setStateMap(
				BlockSapling.TYPE);
		ACBlocks.darklands_oak_leaves =new ACBlock( new BlockACLeaves(ACBlocks.darklands_oak_sapling.getBlock(), MapColor.BLUE).setHardness(0.2F).setResistance(1.0F).setTranslationKey("dltleaves")).setStateMap(
		...
		ACBlocks.darkstone_cobblestone_wall =new ACBlock( new BlockACWall(ACBlocks.darkstone_cobblestone.getBlock()).setHardness(1.65F).setResistance(12.0F).setTranslationKey("dscwall")).setStateMap(BlockWall.VARIANT);
		ACBlocks.wooden_crate =new ACBlock( new BlockCrate().setHardness(3.0F).setResistance(6.0F).setTranslationKey("woodencrate"));
		ACBlocks.oblivion_deathbomb =new ACBlock( new BlockODB().setHardness(3.0F).setResistance(0F).setTranslationKey("odb"), new ItemODB(ACBlocks.oblivion_deathbomb.getBlock()), abyssal_wasteland, true).setStateMap(
				BlockTNT.EXPLODE);
		...
		ACBlocks.odb_core =new ACBlock( new BlockODBcore().setHardness(3.0F).setResistance(0F).setTranslationKey("odbcore")).setStateMap(BlockTNT.EXPLODE);
		ACBlocks.darkstone_slab =new ACBlock( new BlockACSingleSlab(Material.ROCK, SoundType.STONE, MapColor.BLACK).setCreativeTab(ACTabs.tabBlock).setHardness(1.65F).setResistance(12.0F).setTranslationKey("darkstoneslab1"), new ItemSlabAC(ACBlocks.darkstone_slab.getBlock(), ACBlocks.darkstone_slab.getBlock(), ACBlocks.Darkstoneslab2.getBlock())).setStateMap(BlockACSlab.VARIANT_PROPERTY);
		...
		ACBlocks.darklands_oak_slab =new ACBlock( new BlockACSingleSlab(Material.WOOD, SoundType.WOOD, MapColor.BROWN).setHardness(2.0F).setResistance(5.0F).setTranslationKey("dltslab1"), new ItemSlabAC(ACBlocks.darklands_oak_slab.getBlock(), ACBlocks.darklands_oak_slab.getBlock(), ACBlocks.DLTslab2.getBlock())).setStateMap(BlockACSlab.VARIANT_PROPERTY);
		...
		ACBlocks.cracked_abyssalnite_stone_brick =new ACBlock(2, new BlockACBrick(4, 2.5F, 20.0F, MapColor.PURPLE).remap("abydreadbrick", EnumBrickType.CRACKED).setTranslationKey("cracked_abyssalnite_stone_brick"), dreadlands).setStateMap(BlockSapling.TYPE);
		...
		ACBlocks.dreadlands_leaves =new ACBlock( new BlockACLeaves(ACBlocks.dreadlands_sapling.getBlock(), MapColor.RED).setHardness(0.2F).setResistance(1.0F).setTranslationKey("dreadleaves"),dreadlands).setStateMap(BlockLeaves.CHECK_DECAY, BlockLeaves.DECAYABLE);
		...
		ACBlocks.chagaroth_altar_top =new ACBlock(new BlockDreadAltarTop().setHardness(30.0F).setResistance(300.0F).setCreativeTab(ACTabs.tabDecoration).setTranslationKey("dreadaltartop"),dreadlands, true);
		ACBlocks.chagaroth_altar_bottom =new ACBlock( new BlockDreadAltarBottom().setHardness(30.0F).setResistance(300.0F).setCreativeTab(ACTabs.tabDecoration).setTranslationKey("dreadaltarbottom"),dreadlands, true);
		...
		ACBlocks.engraver =new ACBlock( new BlockEngraver().setHardness(2.5F).setResistance(12.0F).setTranslationKey("engraver"),omothol, true);
		...
		ACBlocks.cthulhu_statue =new ACBlock( new BlockStatue(EnumDeityType.CTHULHU).setTranslationKey("cthulhustatue"), true);
		ACBlocks.hastur_statue =new ACBlock( new BlockStatue(EnumDeityType.HASTUR).setTranslationKey("hasturstatue"), true);
		ACBlocks.jzahar_statue =new ACBlock( new BlockStatue(EnumDeityType.JZAHAR).setTranslationKey("jzaharstatue"), true);
		ACBlocks.azathoth_statue =new ACBlock( new BlockStatue(EnumDeityType.AZATHOTH).setTranslationKey("azathothstatue"), true);
		ACBlocks.nyarlathotep_statue =new ACBlock( new BlockStatue(EnumDeityType.NYARLATHOTEP).setTranslationKey("nyarlathotepstatue"), true);
		ACBlocks.yog_sothoth_statue =new ACBlock( new BlockStatue(EnumDeityType.YOGSOTHOTH).setTranslationKey("yogsothothstatue"), true);
		ACBlocks.shub_niggurath_statue =new ACBlock( new BlockStatue(EnumDeityType.SHUBNIGGURATH).setTranslationKey("shubniggurathstatue"), true);
		...
		ACBlocks.mimic_fire =new ACBlock( new BlockMimicFire().setTranslationKey("fire")).setStateMap(BlockFire.AGE);
		ACBlocks.decorative_cthulhu_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.CTHULHU).setTranslationKey("cthulhustatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_cthulhu_statue.getBlock()), true);
		ACBlocks.decorative_hastur_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.HASTUR).setTranslationKey("hasturstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_hastur_statue.getBlock()), true);
		ACBlocks.decorative_jzahar_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.JZAHAR).setTranslationKey("jzaharstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_jzahar_statue.getBlock()), true);
		ACBlocks.decorative_azathoth_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.AZATHOTH).setTranslationKey("azathothstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_azathoth_statue.getBlock()), true);
		ACBlocks.decorative_nyarlathotep_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.NYARLATHOTEP).setTranslationKey("nyarlathotepstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_nyarlathotep_statue.getBlock()), true);
		ACBlocks.decorative_yog_sothoth_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.YOGSOTHOTH).setTranslationKey("yogsothothstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_yog_sothoth_statue.getBlock()), true);
		ACBlocks.decorative_shub_niggurath_statue =new ACBlock( new BlockDecorativeStatue(EnumDeityType.SHUBNIGGURATH).setTranslationKey("shubniggurathstatue"), new ItemDecorativeStatueBlock(ACBlocks.decorative_shub_niggurath_statue.getBlock()), true);
		...
		ACBlocks.abyssal_cobblestone_wall =new ACBlock( new BlockACWall(ACBlocks.abyssal_cobblestone.getBlock(), 2).setHardness(2.6F).setResistance(12.0F).setTranslationKey("abyssalcobblestonewall"),abyssal_wasteland).setStateMap(BlockWall.VARIANT);
		...
		ACBlocks.dreadstone_cobblestone_wall =new ACBlock( new BlockACWall(ACBlocks.dreadstone_cobblestone.getBlock(), 4).setHardness(3.3F).setResistance(20.0F).setTranslationKey("dreadstonecobblestonewall"),dreadlands).setStateMap(BlockWall.VARIANT);
		...
		ACBlocks.abyssalnite_cobblestone_wall =new ACBlock( new BlockACWall(ACBlocks.abyssalnite_cobblestone.getBlock(), 4).setHardness(3.3F).setResistance(20.0F).setTranslationKey("abyssalnitecobblestonewall"),dreadlands).setStateMap(BlockWall.VARIANT);
		...
		ACBlocks.coralium_cobblestone_wall =new ACBlock( new BlockACWall(ACBlocks.coralium_cobblestone.getBlock()).setHardness(2.0F).setResistance(10.0F).setTranslationKey("coraliumcobblestonewall"),abyssal_wasteland).setStateMap(BlockWall.VARIANT);
		...
		ACBlocks.darklands_oak_door =new ACBlock( new BlockACDoor(Material.WOOD, 3.0F, 15.0F, SoundType.WOOD, MapColor.BROWN).setTranslationKey("door_dlt"),
				(ItemBlock) null).setStateMap(BlockDoor.POWERED);
