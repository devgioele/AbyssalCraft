...
public class AChouse2 extends StructureDarklandsBase {
	...
	public boolean generate(World world, Random random, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 0, j + 0, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 0, j + 0, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 0, j + 0, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 0, j + 0, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 0, j + 0, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 1, j + 0, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 1, j + 0, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 2, j + 0, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 2, j + 0, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 2, j + 4, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 0, k + 1), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 0, k + 11), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 4, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 4, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 5, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 5, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 6, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 6, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 7, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 3, j + 7, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 4, j + 0, k + 0), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 4), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 6), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		world.setBlockState(new BlockPos(i + 3, j + 8, k + 8), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 0, k + 12), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 4, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 4, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		...
		world.setBlockState(new BlockPos(i + 4, j + 10, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 4, j + 10, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 4, j + 10, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 4, j + 10, k + 5), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		world.setBlockState(new BlockPos(i + 4, j + 10, k + 7), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		world.setBlockState(new BlockPos(i + 5, j + 0, k + 0), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 0, k + 12), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 4, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 4, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 5, j + 9, k + 4), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 5, j + 9, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 5, j + 9, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 5, j + 9, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 5, j + 9, k + 8), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 5, j + 10, k + 4), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 5, j + 11, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 5, j + 11, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 5, j + 10, k + 8), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		world.setBlockState(new BlockPos(i + 5, j + 11, k + 6), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(0), 2);
		world.setBlockState(new BlockPos(i + 6, j + 0, k + 0), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 6, j + 0, k + 12), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 6, j + 4, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 6, j + 4, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 6, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 6, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		world.setBlockState(new BlockPos(i + 6, j + 9, k + 4), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 6, j + 9, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 6, j + 9, k + 6), ACBlocks.getInstance().glowing_darkstone_bricks.getBlock().getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 6, j + 9, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 6, j + 9, k + 8), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 6, j + 10, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 6, j + 10, k + 5), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 6, j + 10, k + 6), ACBlocks.getInstance().darkstone.getBlock().getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 6, j + 10, k + 7), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 6, j + 10, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 6, j + 11, k + 5), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		world.setBlockState(new BlockPos(i + 6, j + 11, k + 6), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 6, j + 12, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 6, j + 11, k + 7), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		world.setBlockState(new BlockPos(i + 7, j + 0, k + 0), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 0, k + 12), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 4, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 4, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 7, j + 9, k + 4), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 7, j + 9, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 7, j + 9, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 7, j + 9, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(13), 2);
		world.setBlockState(new BlockPos(i + 7, j + 9, k + 8), getBrick(random), 2);
		world.setBlockState(new BlockPos(i + 7, j + 10, k + 4), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 7, j + 11, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 7, j + 11, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 8, j + 0, k + 0), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 7, j + 10, k + 8), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		world.setBlockState(new BlockPos(i + 7, j + 11, k + 6), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 0, k + 12), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 4, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 4, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(2), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(3), 2);
		...
		world.setBlockState(new BlockPos(i + 8, j + 10, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 8, j + 10, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 8, j + 10, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 1), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 8, j + 10, k + 5), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		world.setBlockState(new BlockPos(i + 8, j + 10, k + 7), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 11), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 4, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 4, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 5, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 5, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 6, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 6, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 7, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 9, j + 7, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 10, j + 0, k + 2), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 4), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 6), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		world.setBlockState(new BlockPos(i + 9, j + 8, k + 8), ACBlocks.getInstance().darkstone_brick_stairs.getBlock().getStateFromMeta(1), 2);
		...
		world.setBlockState(new BlockPos(i + 10, j + 0, k + 10), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 10, j + 4, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 10, j + 4, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 10, j + 4, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 10, j + 4, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 10, j + 4, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 11, j + 0, k + 3), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		...
		world.setBlockState(new BlockPos(i + 11, j + 0, k + 9), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 12, j + 0, k + 4), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 12, j + 0, k + 5), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 12, j + 0, k + 6), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 12, j + 0, k + 7), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
		world.setBlockState(new BlockPos(i + 12, j + 0, k + 8), ACBlocks.getInstance().darkstone_brick_slab.getBlock().getStateFromMeta(5), 2);
